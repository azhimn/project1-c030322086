                    ...
                    <div class="card-body">
                        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea type="text" class="form-control @error('description') is-invalid @enderror" name="description" row="5" placeholder="Masukkan deskripsi produk">{{  old('description') }}</textarea>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('price') is-invalid @enderror" name="price" placeholder="Masukkan harga produk" value="{{ old('price') }}">
