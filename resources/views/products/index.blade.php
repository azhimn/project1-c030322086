        ...
        <div class="row">
            <div class="col-md-12">
                <div>
                    ...
                    <h3 class="text-center"><a href="https://poliban.ac.id">www.poliban.ac.id</a></h3>
                    <hr>
                </div>
                <div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="class-center">
                                            <img src="{{ asset('/storage/products/' . $product->image) }}" alt="" class="rounded" style="width: 150px;">
                                        </td>
                                        <td>{{ $product->title }}</td>
